...
public class BattleSystem : MonoBehaviour
{
    ...
    BattleState state; // here State can't be null
    
    int currentAction; // 0->Fight and 1->Run
    int currentMove;
    ...
    void BattleOver(bool won)
    {
        ...
        playerParty.Pokemons.ForEach(p => p.OnBattleOver()); //short-hand of writing *for-each* using links
    ...
    IEnumerator ChooseMoveToForget(Pokemon pokemon,MoveBase newMove)
    {
        ...
        moveSelectionUI.SetMoveData(pokemon.Moves.Select(x => x.Base).ToList(), newMove); // Converts a List of Move class to a List of MoveBase class
        moveToLearn = newMove;
    ...
    IEnumerator RunTurns(BattleAction playerAction)
    {
        ...
        else
        {
            ...
            {
                // This is handled from item screen, so do nothing and skip to the enemy move
                dialogBox.EnableActionSelector(false);
            }
