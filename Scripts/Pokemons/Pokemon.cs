...
public class Pokemon
{
    ...
    public Pokemon(PokemonSaveData saveData)
    {
        ...
        // Restoring moves from the saved data
    ...
    // To convert Pokemon class to PokemonSaveData class
    ...
    {
        var movesWithPP = Moves.Where(x => x.PP > 0).ToList(); // Contains list of moves that has some PP
    ...
    {
        Status?.OnAfterTurn?.Invoke(this); //Null conditional operator
