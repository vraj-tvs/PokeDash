...
public class GameController : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        Cursor.lockState = CursorLockMode.Locked; // To prevent using mouse in game
        Cursor.visible = false; // To hide the cursor in game
    ...
    private void Update()
    {
        if (state == GameState.FreeRoam)
        {
            ...
            // Return is key code for enter button(key)
